...
class MeatCutsChartPlugin extends _core.ChartPlugin {
  /**
  ...
  constructor() {
    const metadata = new _core.ChartMetadata({
      ...
      name: (0, _core.t)('Meat Cuts'),
      thumbnail: _thumbnail.default
    });
    super({
      buildQuery: _buildQuery.default,
      controlPanel: _controlPanel.default,
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../MeatCuts'))),
      metadata,
...
exports.default = MeatCutsChartPlugin;